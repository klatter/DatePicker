...
define([
    ...
    "BirthdayPicker/lib/jquery-1.11.2",
    "dojo/text!BirthdayPicker/widget/template/BirthdayPicker.html"
    ...
    return declare("BirthdayPicker.widget.BirthdayPicker", [ _WidgetBase, _TemplatedMixin ], {
...
require(["BirthdayPicker/widget/BirthdayPicker"]);
